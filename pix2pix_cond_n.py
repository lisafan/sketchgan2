...
def load_examples():
    ...
    paths_batch, inputs_batch, targets_batch, classes_real_batch, classes_fake_batch = \
	tf.train.batch([paths, input_images, target_images, classes_real, classes_fake], batch_size=a.batch_size)
